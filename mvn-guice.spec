...
Source5  : https://repo1.maven.org/maven2/com/google/inject/guice-parent/4.2.1/guice-parent-4.2.1.pom
Source6  : https://repo1.maven.org/maven2/com/google/inject/guice/3.0/guice-3.0.jar
Source7  : https://repo1.maven.org/maven2/com/google/inject/guice/3.0/guice-3.0.pom
Source8  : https://repo1.maven.org/maven2/com/google/inject/guice/4.2.1/guice-4.2.1-no_aop.jar
Source9  : https://repo1.maven.org/maven2/com/google/inject/guice/4.2.1/guice-4.2.1.pom
...
cp %{SOURCE5} %{buildroot}/usr/share/java/.m2/repository/com/google/inject/guice-parent/4.2.1

mkdir -p %{buildroot}/usr/share/java/.m2/repository/com/google/inject/guice/3.0
cp %{SOURCE6} %{buildroot}/usr/share/java/.m2/repository/com/google/inject/guice/3.0
...
cp %{SOURCE8} %{buildroot}/usr/share/java/.m2/repository/com/google/inject/guice/4.2.1

mkdir -p %{buildroot}/usr/share/java/.m2/repository/com/google/inject/guice/4.2.1
cp %{SOURCE9} %{buildroot}/usr/share/java/.m2/repository/com/google/inject/guice/4.2.1
