...
Source5  : https://repo1.maven.org/maven2/com/google/inject/extensions/guice-servlet/3.0/guice-servlet-3.0.jar
Source6  : https://repo1.maven.org/maven2/com/google/inject/extensions/guice-servlet/3.0/guice-servlet-3.0.pom
Source7  : https://repo1.maven.org/maven2/com/google/inject/guice-parent/3.0/guice-parent-3.0.pom
Source8  : https://repo1.maven.org/maven2/com/google/inject/guice-parent/4.0/guice-parent-4.0.pom
Source9  : https://repo1.maven.org/maven2/com/google/inject/guice-parent/4.2.1/guice-parent-4.2.1.pom
Source10  : https://repo1.maven.org/maven2/com/google/inject/guice/3.0/guice-3.0.jar
Source11  : https://repo1.maven.org/maven2/com/google/inject/guice/3.0/guice-3.0.pom
Source12  : https://repo1.maven.org/maven2/com/google/inject/guice/4.0/guice-4.0.jar
Source13  : https://repo1.maven.org/maven2/com/google/inject/guice/4.0/guice-4.0.pom
Source14  : https://repo1.maven.org/maven2/com/google/inject/guice/4.2.1/guice-4.2.1-no_aop.jar
Source15  : https://repo1.maven.org/maven2/com/google/inject/guice/4.2.1/guice-4.2.1.pom
Source16  : https://repo1.maven.org/maven2/org/sonatype/sisu/inject/guice-bean/1.4.2/guice-bean-1.4.2.pom
Source17  : https://repo1.maven.org/maven2/org/sonatype/sisu/inject/guice-bean/2.3.0/guice-bean-2.3.0.pom
Source18  : https://repo1.maven.org/maven2/org/sonatype/sisu/inject/guice-parent/3.1.0/guice-parent-3.1.0.pom
...
cp %{SOURCE5} %{buildroot}/usr/share/java/.m2/repository/com/google/inject/extensions/guice-servlet/3.0/guice-servlet-3.0.jar

mkdir -p %{buildroot}/usr/share/java/.m2/repository/com/google/inject/extensions/guice-servlet/3.0
cp %{SOURCE6} %{buildroot}/usr/share/java/.m2/repository/com/google/inject/extensions/guice-servlet/3.0/guice-servlet-3.0.pom

mkdir -p %{buildroot}/usr/share/java/.m2/repository/com/google/inject/guice-parent/3.0
cp %{SOURCE7} %{buildroot}/usr/share/java/.m2/repository/com/google/inject/guice-parent/3.0/guice-parent-3.0.pom

mkdir -p %{buildroot}/usr/share/java/.m2/repository/com/google/inject/guice-parent/4.0
cp %{SOURCE8} %{buildroot}/usr/share/java/.m2/repository/com/google/inject/guice-parent/4.0/guice-parent-4.0.pom

mkdir -p %{buildroot}/usr/share/java/.m2/repository/com/google/inject/guice-parent/4.2.1
cp %{SOURCE9} %{buildroot}/usr/share/java/.m2/repository/com/google/inject/guice-parent/4.2.1/guice-parent-4.2.1.pom

mkdir -p %{buildroot}/usr/share/java/.m2/repository/com/google/inject/guice/3.0
cp %{SOURCE10} %{buildroot}/usr/share/java/.m2/repository/com/google/inject/guice/3.0/guice-3.0.jar

mkdir -p %{buildroot}/usr/share/java/.m2/repository/com/google/inject/guice/3.0
cp %{SOURCE11} %{buildroot}/usr/share/java/.m2/repository/com/google/inject/guice/3.0/guice-3.0.pom

mkdir -p %{buildroot}/usr/share/java/.m2/repository/com/google/inject/guice/4.0
cp %{SOURCE12} %{buildroot}/usr/share/java/.m2/repository/com/google/inject/guice/4.0/guice-4.0.jar

mkdir -p %{buildroot}/usr/share/java/.m2/repository/com/google/inject/guice/4.0
cp %{SOURCE13} %{buildroot}/usr/share/java/.m2/repository/com/google/inject/guice/4.0/guice-4.0.pom

mkdir -p %{buildroot}/usr/share/java/.m2/repository/com/google/inject/guice/4.2.1
cp %{SOURCE14} %{buildroot}/usr/share/java/.m2/repository/com/google/inject/guice/4.2.1/guice-4.2.1-no_aop.jar

mkdir -p %{buildroot}/usr/share/java/.m2/repository/com/google/inject/guice/4.2.1
cp %{SOURCE15} %{buildroot}/usr/share/java/.m2/repository/com/google/inject/guice/4.2.1/guice-4.2.1.pom

mkdir -p %{buildroot}/usr/share/java/.m2/repository/org/sonatype/sisu/inject/guice-bean/1.4.2
cp %{SOURCE16} %{buildroot}/usr/share/java/.m2/repository/org/sonatype/sisu/inject/guice-bean/1.4.2/guice-bean-1.4.2.pom

mkdir -p %{buildroot}/usr/share/java/.m2/repository/org/sonatype/sisu/inject/guice-bean/2.3.0
cp %{SOURCE17} %{buildroot}/usr/share/java/.m2/repository/org/sonatype/sisu/inject/guice-bean/2.3.0/guice-bean-2.3.0.pom

mkdir -p %{buildroot}/usr/share/java/.m2/repository/org/sonatype/sisu/inject/guice-parent/3.1.0
cp %{SOURCE18} %{buildroot}/usr/share/java/.m2/repository/org/sonatype/sisu/inject/guice-parent/3.1.0/guice-parent-3.1.0.pom
